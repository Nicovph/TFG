...
class PromptConstructionTests(SimpleTestCase):
    ...
    def test_system_prompt_defines_semantics_and_uses_shared_limits(self) -> None:
        ...
        expected_semantics = (
            ...
            "identifica internamente todas las frases hechas y expresiones no literales",
            "sustituye cada una por su sentido directo",
            "comprueba que no quede ninguna",
            "Devuelve solo la reformulación final, no ese análisis",
